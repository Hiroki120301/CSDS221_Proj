                ...
                <!--table header-->
                    ...
                    <tbody>
                        <tr v-for="(item, index) in listOfTasks" v-bind:key="index" :task="item">
                            ...
                            <td>
                                <div v-if="!item.checked"><v-btn color="primary" class="mr-4" width="100px"><AddTask name="UPDATE" @edit-task="editTask($event, index)"/></v-btn></div>
                                <div><v-btn color="error" class="mr-4" width="100px" @click="deleteTask(index)"><v-icon small>mdi-close-circle-outline</v-icon>DELETE </v-btn></div>
                            </td>
                        </tr>
                    </tbody>
                </template>
